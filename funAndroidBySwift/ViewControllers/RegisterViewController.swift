...
class RegisterViewController: BaseViewController {
    ...
    let viewModel = RegisterModelView()
    override func viewDidLoad() {
        ...
        let rePassword = repPasswordTF.rx.text.filterNil()
        
        let input = RegisterModelView.Input(userName: userName, password: password, repPassword: rePassword, register: registerBtn.rx.tap.asObservable())
